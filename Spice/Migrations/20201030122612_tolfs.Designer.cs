...
namespace Spice.Migrations
{
    ...
    [Migration("20201030122612_tolfs")]
    partial class tolfs
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Spice.Models.OrdarDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("OrdarId")
                        .HasColumnType("int");

                    b.Property<double>("Pric")
                        .HasColumnType("float");
                    ...
                    b.ToTable("OrdarDetail");
                });

            modelBuilder.Entity("Spice.Models.OrdarHedar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<double>("CoupnCodeDiscount")
                        .HasColumnType("float");

                    b.Property<DateTime>("OrdarDate")
                        .HasColumnType("datetime2");

                    b.Property<double>("OrdarTotal")
                        .HasColumnType("float");

                    b.Property<double>("OrdarTotalOregnal")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Spice.Models.OrdarDetails", b =>
                {
                    ...
                    b.HasOne("Spice.Models.OrdarHedar", "OrdarHedar")
                        .WithMany()
                        .HasForeignKey("OrdarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
